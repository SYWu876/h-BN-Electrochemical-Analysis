...
bdf.to_csv(out / "Figure2d_b_values.csv", index=False)
...
fig.tight_layout()
fig.savefig(out / "Figure2d_hBN_b_profile.png", bbox_inches="tight")
fig.savefig(out / "Figure2d_hBN_b_profile.pdf", bbox_inches="tight")
