...
out = processed_dir()
df = peak_summary()
df.to_csv(out / "CV_peak_summary.csv", index=False)
...
fig.tight_layout()
fig.savefig(out / "CV_peak_vs_sqrtv.png", bbox_inches="tight")
fig.savefig(out / "CV_peak_vs_sqrtv.pdf", bbox_inches="tight")
