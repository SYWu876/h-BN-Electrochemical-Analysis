...
ising.to_csv(out / "Figure4a_Ising_segmentation_data.csv", index=False)
...
fig.tight_layout()
fig.savefig(out / "Figure4a_hBN_Ising_segmentation.png", bbox_inches="tight")
fig.savefig(out / "Figure4a_hBN_Ising_segmentation.pdf", bbox_inches="tight")
plt.close(fig)

# 4b
coords = qkpca_coordinates(branches)
coords.to_csv(out / "Figure4b_QKPCA_coordinates.csv", index=False)
...
style_axes(ax)
fig.tight_layout()
fig.savefig(out / "Figure4b_hBN_QKPCA.png", bbox_inches="tight")
fig.savefig(out / "Figure4b_hBN_QKPCA.pdf", bbox_inches="tight")
