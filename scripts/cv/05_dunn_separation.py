...
prof.to_csv(out / "CV_Dunn_partition_data.csv", index=False)
frac.to_csv(out / "CV_fractional_capacitive.csv", index=False)
...
style_axes(ax)
fig.tight_layout()
fig.savefig(out / "CV_Dunn_k1.png", bbox_inches="tight")
fig.savefig(out / "CV_Dunn_k1.pdf", bbox_inches="tight")
plt.close(fig)
...
style_axes(ax)
fig.tight_layout()
fig.savefig(out / "CV_Dunn_k2.png", bbox_inches="tight")
fig.savefig(out / "CV_Dunn_k2.pdf", bbox_inches="tight")
plt.close(fig)
...
style_axes(ax)
fig.tight_layout()
fig.savefig(out / "CV_fractional_capacitive.png", bbox_inches="tight")
fig.savefig(out / "CV_fractional_capacitive.pdf", bbox_inches="tight")
